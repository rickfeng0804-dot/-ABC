    ...
    <header className="bg-slate-900/90 backdrop-blur-md text-white sticky top-0 z-40 border-b border-slate-800/80 shadow-lg">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16">
          ...
          {/* Action Buttons & Quick Scan */}
          <div className="flex items-center gap-3">
            <button
              onClick={openBarcodeScanner}
              className="flex items-center gap-2 px-3.5 py-1.5 rounded-lg bg-blue-600 hover:bg-blue-500 text-white font-medium text-xs transition shadow-md shadow-blue-900/20 active:scale-95"
            >
            ...
            {alertCount > 0 && (
              <button
                ...
                className="flex items-center gap-1.5 px-3 py-1.5 rounded-lg bg-red-500/10 border border-red-500/20 text-red-400 hover:bg-red-500/20 text-xs font-semibold transition"
